...
//                            .setTitleBarBgColor(Color.rgb(0x00, 0x00, 0x00))
...
//
//
//                CoreConfig coreConfig = new CoreConfig.Builder(MainActivityTest.this, imageLoader, themeConfig)
...
//                GalleryFinal.init(coreConfig);
                ...
                ActionSheet.createBuilder(MainActivityTest.this, getSupportFragmentManager())
...
//                                        }
                                    ...
                                    case 2:
                                        if (new File(path).exists()) {
                                            ...
                                            Toast.makeText(MainActivityTest.this, "图片不存在", Toast.LENGTH_SHORT).show();
                                        }
                                        break;
                                    case 3:
                                        if (new File(path).exists()) {
                                            GalleryFinal.openEdit(REQUEST_CODE_EDIT, path, mOnHanlderResultCallback);
                                        } else {
                                            Toast.makeText(MainActivityTest.this, "图片不存在", Toast.LENGTH_SHORT).show();
                                        }
                                        break;
    ...
    private GalleryFinal.OnHanlderResultCallback mOnHanlderResultCallback = new GalleryFinal.OnHanlderResultCallback() {
        ...
        public void onHanlderFailure(int requestCode, String errorMsg) {
            Toast.makeText(MainActivityTest.this, errorMsg, Toast.LENGTH_SHORT).show();
        }
    };
